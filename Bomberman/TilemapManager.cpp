...
bool TilemapManager::Save(std::string mapTitle)
{
...
std::vector<std::vector<char>> TilemapManager::ReadFile(std::string filePath)
{
...
void TilemapManager::SaveFile(std::string mapTitle)
{
    std::ofstream file;
...
bool TilemapManager::EditTilemap(std::string filePath)
{
    std::vector<std::vector<char>> tilemap = ReadFile(filePath);
    if (IsValidTilemap(tilemap))
    {
...
void TilemapManager::PlayInTilemap(std::string tilemapPath)
{
    xFillId = 0;
    yFillId = 0;
    xFillLoops = 0;
