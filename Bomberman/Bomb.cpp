...
bool Bomb::SpawnExplosions(b2Vec2 startPoint, b2Vec2 endPoint, glm::vec2 spawnPoint)
{
	...
	auto fixture = physicsComponent->Raycast(startPoint, endPoint);

	if (fixture != nullptr)
	{
		auto& bodyData = fixture->GetBody()->GetUserData();
		auto object = reinterpret_cast<GameObject*>(bodyData.pointer);
