...
void AudioSubsystem::PlayMusic(std::string title)
{
	soundEngine->play2D(sounds[title], true);
}

void AudioSubsystem::PlaySFX(std::string title)
{
...
void AudioSubsystem::AddSound(std::string title, std::string pathFile, float volume)
{
